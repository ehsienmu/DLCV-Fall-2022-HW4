...
from .load_blender import load_blender_data, load_dlcv_test_data
...
def load_data(args):
    ...
    elif args.dataset_type == 'blender': #DLCV hotdog
    ...
    elif args.dataset_type == 'dlcv': #DLCV hotdog
        # pdb.set_trace()
        # images, poses, render_poses, hwf, i_split, i_filenames = load_dlcv_test_data(args.datadir, args.half_res, args.testskip)
        images, poses, render_poses, hwf, i_split, i_filenames = load_dlcv_test_data(args.render_test_dlcv_json_path, args.half_res, args.testskip)
        print('Loaded blender', images.shape, render_poses.shape, hwf, args.datadir)
        i_test = i_split
        i_test_filenames = i_filenames
    ...
    if args.dataset_type == 'dlcv': #DLCV hotdog
        data_dict = dict(
            hwf=hwf, HW=HW, Ks=Ks,
